...
<!-- PHP for LogoAnimation -->
<h1 id="LogoAnimation" style="text-align:center;margin-top:100px;margin-bottom:100px;font-size:8vw">Logo Animation</h1>
...
$query="SELECT ProjectName,ProjectId,ProjectDescription,HirerName,HirerId from project WHERE LogoAnimation=1";
...
<h1 id="VideoEditing" style="text-align:center;margin-top:100px;margin-bottom:100px;font-size:8vw">Video Editing</h1>
...
$query="SELECT ProjectName,ProjectId,ProjectDescription,HirerName,HirerId from project WHERE VideoEditing=1";
$results = mysqli_query($link,$query); 
// $log=mysqli_fetch_assoc($results);
while ($row = mysqli_fetch_assoc($results))
{
...
?>
<!-- End of php -->
<!--php for Animated GIFs-->
<h1 id="AnimatedGIF" style="text-align:center;margin-top:100px;margin-bottom:100px;font-size:8vw">Animated GIF's</h1>
...
$query="SELECT ProjectName,ProjectId,ProjectDescription,HirerName,HirerId from project WHERE AnimatedGIF=1";
$results = mysqli_query($link,$query); 
// $log=mysqli_fetch_assoc($results);
while ($row = mysqli_fetch_assoc($results))
{
