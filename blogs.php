...
<body>
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <form class="d-flex" action="search_engine.php" method="post">
                            <input class="form-control me-2" type="search" style="" placeholder="Search"
                                aria-label="Search" id="search" name="search">
                            <button class="btn btn-outline-success" type="submit" style="">Search</button>
                        </form>
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            <li class="nav-item">
                                <a class="nav-link " aria-current="page" style="padding-right:200px"
                                    href="howitworks.php">How it Works</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link fas fa-home" aria-current="page" style="font-size:30px;color:red"
                                    href="main.php"></a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <button class="navbar-brand btn btn-outline-success" style="border-radius:20px;"
                        ...
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown" href="#" id="navbarDropdown" role="button"
                                    data-bs-toggle="dropdown" aria-expanded="true" style="color:white;padding:20px">
                                    Graphics & Design
                                </a>
                                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <li><a class="dropdown-item" href="graphics.php/#LogoDesign" style="">Logo
                                            Design</a>
                                    </li>
                                    <li><a class="dropdown-item" href="graphics.php/#Photoshop" style="">Photoshop</a>
                                    </li>
                                    <li><a class="dropdown-item" href="graphics.php/#AddsDesign" style="">Adds
                                            Design</a>
                                    </li>
                                    <li><a class="dropdown-item" href="graphics.php/#SocialMediaDesign" style="">Social
                                            Media Design</a></li>
                                </ul>
                            </li>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <li><a class="dropdown-item" href="writing.php/#ContentWriting">Content Writing</a>
                                    </li>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <li><a class="dropdown-item" href="tech.php/#WebDevelopment">Web Development</a>
                                    </li>
                                    <li><a class="dropdown-item" href="tech.php/#GameDevelopment">Game Development</a>
                                    </li>
                                    <li><a class="dropdown-item" href="tech.php/#WordPress">Wordpress</a></li>
                                    <li><a class="dropdown-item" href="tech.php/#AppDevelopment">App Development</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="nav-item dropdown">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <li><a class="dropdown-item" href="Business.php/#SocialMediaMarketing">Social Media
                                            Marketing</a></li>
                                    <li><a class="dropdown-item" href="Business.php/#Sales_Marketing">Sales &
                                            Marketing</a>
                                    </li>
  ...
  <div class="col">
    <div class="card h-100">
      <img src="tip.jpg" class="card-img-top" alt="Image">
      <div class="card-body">
        <h5 class="card-title">Tip of the day</h5>
        <p class="card-text">Connect with more experienced freelancers in your local area or online via social media or their websites. Sometimes they will have overflow work they need to refer on or can give you a few pointers.</p>
      </div>
      <div class="card-footer">
        <small class="text-muted">Last updated some days ago</small>
      </div>
    </div>
  </div>
  <div class="col">
    <div class="card h-100">
      <img src="content.jpg" class="card-img-top" alt="Image">
      <div class="card-body">
        <h5 class="card-title">What is Content Writing?</h5>
        <p class="card-text">Content writing is the process of planning, writing and editing web content, typically for digital marketing purposes. It can include writing blog posts and articles, scripts for videos and podcasts, as well as content for specific platforms, such as tweetstorms on Twitter or text posts on Reddit.</p>
      </div>
      <div class="card-footer">
        <small class="text-muted">Last updated some days ago</small>
      </div>
  ...
  <div class="col">
    <div class="card h-100">
      <img src="gig.png" class="card-img-top" alt="Image">
      <div class="card-body">
        <h5 class="card-title">What are some famous freelancing gigs?</h5>
        <p class="card-text">Programming, development, content writing, social media marketing, graphics, design and animation are some famous freelancing gigs.</p>
      </div>
      <div class="card-footer">
        <small class="text-muted">Last updated some days ago</small>
      </div>
