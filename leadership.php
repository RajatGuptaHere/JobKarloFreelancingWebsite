...
<body>
    ...
    <!-- find work modal -->
    <div class="modal fade" id="findWorkModal" style="margin-top:50px" tabindex="-1" aria-labelledby="loginModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
           ...
           <hr>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="btn-group" role="group" aria-label="Basic checkbox toggle button group">
                                ...
                                <label class="btn btn-outline-primary" for="LogoDesign"><a class=" " href="graphics.php/#LogoDesign" style="text-decoration:none">Logo
                                        Design</a></label>
                                ...
                                <label class="btn btn-outline-primary" for="Adds Design"><a class="" href="graphics.php/#AddsDesign" style="text-decoration:none">Adds
                                        Design</a></label>
                                <input type="radio" class="btn-check" id="Social Media Design" autocomplete="off">
                                <label class="btn btn-outline-primary" for="Social Media Design"><a class="" href="graphics.php/#SocialMediaDesign" style="text-decoration:none">Social Media
                                        Design</a></label>
                                <input type="radio" class="btn-check" id="Logo Animation" autocomplete="off">
                                <label class="btn btn-outline-primary" for="Logo Animation"><a class="" href="video.php/#LogoAnimation" style="text-decoration:none">Logo
                                        Animation</a></label>
                                <input type="radio" class="btn-check" id="Video Editing" autocomplete="off">
                                <label class="btn btn-outline-primary" for="Video Editing"><a class="" href="video.php/#VideoEditing" style="text-decoration:none">Video
                                        Editing</a></label>
                                <input type="radio" class="btn-check" id="Animated GIF's" autocomplete="off">
                                <label class="btn btn-outline-primary" for="Animated GIF's"><a class="" href="video.php/#AnimatedGIF" style="text-decoration:none">Animated
                                        GIF's</a></label>
                                <input type="radio" class="btn-check" id="Content Writing" autocomplete="off">
                                <label class="btn btn-outline-primary" for="Content Writing"><a class="" href="writing.php/#ContentWriting" style="text-decoration:none">Content
                                        Writing</a></label>
                                ...
                                <label class="btn btn-outline-primary" for="Web Development"><a class="" href="tech.php/#WebDevelopment" style="text-decoration:none">Web
                                        Development</a></label>
                            </div>
                            ...
                            <div class="btn-group" role="group" aria-label="Basic checkbox toggle button group" style="margin-top:25px">
                                ...
                                <label class="btn btn-outline-warning" for="Social Media Marketing"><a class="" href="Business.php/#SocialMediaMarketing" style="text-decoration:none;color:rgb(255,207,64);">Social Media
                                        Marketing</a></label>
    ...
    <center><h1  style="color: red; font-weight:5
    6px;">Our Team of JK</h1></center>
    <div class="container my-4">
        <hr>
        <div class="row my-2">
            <div class="col-lg-4 my-2">
                <img src="faizan.jpg" alt="" style="width:70%; height:70%; border-radius:50%;">
                <h2>Faizan Khan</h2>
                <p><i>CEO</i></p>
                <p><i>"Our Motive is make ease for the people all around us"</i></p>

            </div><!-- /.col-lg-4 -->
            <div class="col-lg-4 my-2">
                <img src="rajatgupta.jpeg" alt="" style="width:70%; height:70%; border-radius:50%;">
                <h2>Rajat Gupta</h2>
                <p><i>CEO</i></p>
                <p><i>"Sucess is not Fatal, Failure is not Fatal ,It is the courage to continue that counts"</i></p>

            </div><!-- /.col-lg-4 -->
            <div class="col-lg-4 my-2">
                <img src="rajat_goyal.jpg" alt="" style="width:70%; height:70%; border-radius:50%;">
                <h2>Rajat Goyal</h2>
                <p><i>CEO</i></p>
                <p><i>"Once we've learned the right way to locate and evaluate talent , it has become extremely easy to find the right people for the task"</i></p>
